...
public:
    ...
    friend class ExpressionsVisitor;
    void accept(Visitor &v) override { v.visit(*this); }
...
class FeaturesVisitor : public Visitor {
public:
    Features features;
...
class FormalsVisitor : public Visitor {
public:
