...
int main(int argc, char *argv[]) {
    ...
    {
    case '1':
        vernam_encode("text.txt");
        vernam_decode("text.txt.encode");
        break;
    case '2':
        shamir_cipher("./text.txt");
        break;
    case '3':
        elgamal_encode("text.txt");
        elgamal_decode("text.txt.encode");
        break;
    case '4':
        rsa_encode("text.txt");
        rsa_decode("text.txt.encode");
        break;
