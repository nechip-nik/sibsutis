...
set yrange [0:0.030]  # Диапазон от 0.00 до 0.030
...
plot 'separate.txt' with linespoints lw 2 lt rgb "blue" title '1x2 Separate CPUs', \
     'single.txt' with linespoints lw 2 lt rgb "red" title '1x2 Single CPU', \
     'separate_note.txt' with linespoints lw 2 lt rgb "green" title '2x1 Separate nodes'